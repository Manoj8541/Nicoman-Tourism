...
const Home = () => {
  ...
  const stats = [
    { number: '572', label: 'Islands', icon: GiIsland },
    { number: '50+', label: 'Beaches', icon: GiWaves },
    { number: '100+', label: 'Resorts', icon: GiPalmTree },
    { number: '4.9', label: 'Rating', icon: FaStar },
  ];

  const places = [
    { name: 'Radhanagar Beach', location: 'Havelock Island', image: 'https://thumbs.dreamstime.com/b/radhanagar-beach-one-most-famous-attractions-havelock-island-andaman-nicobar-islands-radhanagar-beach-253126594.jpg', rating: 4.9 },
    { name: 'Cellular Jail', location: 'Port Blair', image: 'https://images.unsplash.com/photo-1721231564051-3b44b8058a9e?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', rating: 4.8 },
    { name: 'Elephant Beach', location: 'Havelock Island', image: 'https://www.andamantourism.org/wp-content/uploads/2025/02/Elephant-beach-1-800x444.jpg', rating: 4.7 },
  ];

  const testimonials = [
    { name: 'Priya Sharma', role: 'Travel Blogger', image: 'https://randomuser.me/api/portraits/women/44.jpg', text: 'Absolutely breathtaking! The beaches here are unlike anything I\'ve ever seen. A true paradise on Earth!' },
    { name: 'Rahul Verma', role: 'Photographer', image: 'https://randomuser.me/api/portraits/men/32.jpg', text: 'Every corner is picture-perfect. The crystal clear waters and vibrant marine life are a photographer\'s dream.' },
    { name: 'Anjali Patel', role: 'Adventure Seeker', image: 'https://randomuser.me/api/portraits/women/68.jpg', text: 'From scuba diving to kayaking, Andaman offers the best adventure experiences. Highly recommend!' },
  ];
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative h-screen flex flex-col">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          {/* Color Overlay */}
          <div className="absolute inset-0 bg-gradient-to-r from-teal-900/30 to-cyan-900/30 mix-blend-overlay" />
        </div>
      ...
      <section className="py-24 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 bg-[url('https://wallpapercave.com/wp/wp7333496.jpg')] bg-cover bg-center mix-blend-overlay opacity-30" />
