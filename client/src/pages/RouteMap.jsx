...
const RouteMap = () => {
  ...
  const fetchRoutes = async () => {
    try {
      const response = await axios.get('http://localhost:5000/api/ship-routes');
      setRoutes(response.data);
      setSelectedRoute(response.data[0]);
      setLoading(false);
    } catch (error) {
      const fallbackRoutes = [
        { id: 1, from: "Chennai Port", fromState: "Tamil Nadu", to: "Port Blair", distance: 647, unit: "nautical miles", travelTime: "12-14 hours", frequency: "3-4 times/month" },
        { id: 2, from: "Kolkata Port", fromState: "West Bengal", to: "Port Blair", distance: 756, unit: "nautical miles", travelTime: "24-26 hours", frequency: "2-3 times/month" },
        { id: 3, from: "Visakhapatnam Port", fromState: "Andhra Pradesh", to: "Port Blair", distance: 684, unit: "nautical miles", travelTime: "18-22 hours", frequency: "2 times/month" }
      ];
          ...
          {routes.map((route) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-lg">{route.fromState}</h3>
              </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="p-6 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl">
                ...
                <p className="text-3xl font-black text-gray-900 dark:text-white">{selectedRoute.travelTime.split('-')[0]}</p>
              ...
              <div className="p-6 bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-orange-900/20 dark:to-yellow-900/20 rounded-2xl">
                ...
                <p className="text-gray-600 dark:text-gray-400">{selectedRoute.fromState}</p>
              </div>
            </div>
          </motion.div>
        )}
