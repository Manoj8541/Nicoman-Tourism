...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: FaPhone, title: 'Phone', details: ['+91 3192 232413', '+91 3192 233006'], color: 'from-green-500 to-emerald-500' },
    { icon: FaEnvelope, title: 'Email', details: ['info@andamantourism.gov.in'], color: 'from-blue-500 to-cyan-500' },
